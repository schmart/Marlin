...
#define HOTEND_OFFSET_X { 0.0, 30.00 } // (mm) relative X-offset for each nozzle
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 64.25, 64.25, 1600, 75 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 3, 2 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 800, 800, 100, 100 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 35, 0, -1.75 }
